...
const Speakers = () => {
  ...
  const speakerImages = {
    ...
    abheekPandoh: 'https://github.com/harvind-here/asset_repo/blob/main/public/images/guest_dp.jpeg?raw=true',
    ghibliGuest: 'https://github.com/harvind-here/asset_repo/blob/main/public/images/ghibli_guest.png?raw=true',
  };
