      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <div className="space-y-4 text-lg leading-relaxed">
            ...
            <p>
            We welcome over top 250 talented techies to our campus for the final round of 24H Hackathon. To be one among them, register your team now and submit the Round-1 ideation before 28th April</p>
            </p>
            <p>
